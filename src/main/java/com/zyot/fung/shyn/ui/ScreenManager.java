...
public class ScreenManager {
    ...
    public void navigate(String screenName, HashMap<String, Object> args) {
        if (screenName.equals(HOME_SCREEN)) {
            ...
            window.getContentPane().removeAll();
            window.getContentPane().add(getNewRoomScreen(playerName, isRoomMaster, port));
            window.revalidate();
            window.repaint();
    ...
    private synchronized RoomScreen getNewRoomScreen(String playerName, Boolean isRoomMaster, int port) {
